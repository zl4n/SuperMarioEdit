...
public class World {
			...
			for(int xx = 0; xx < map.getWidth(); xx++){
				for(int yy = 0; yy < map.getHeight(); yy++){
					...
					if(pixelAtual == 0xFF000000) {
						...
						Enemy enemy = new Enemy(xx*16,yy*16,16,16,1.5,Entity.Enemy1_right);
						Game.entities.add(enemy);
					}else if(pixelAtual == 0xFF7F0000) {
						Enemy2 enemy2 = new Enemy2(xx*16,yy*16,16,16,1.5,Entity.Enemy2_right);
						Game.entities.add(enemy2);
					}else if(pixelAtual == 0xFFFF0000) {
						Enemy3 enemy3 = new Enemy3(xx*16,yy*16,16,16,1.2,Entity.Enemy3_right);
						Game.entities.add(enemy3);
					}else if (pixelAtual == 0xFFF3FF14) {
						Coin coin = new Coin(xx*16,yy*16,16,16,0,Entity.Coin_Right);
	...
	public static void restartGame(){
		//Aplicar metodo para reiniciar o jogo corretamente.
		return;
	}
